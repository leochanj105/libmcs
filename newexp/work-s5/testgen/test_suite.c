...
static void test_ceil_extra2(void)
{
    ...
    printf("ceil %a = %a\n", 1048576.0,  ceil(1048576.0));
    printf("ceil %a = %a\n", 1048576.5,  ceil(1048576.5));
    printf("ceil %a = %a\n", -1048576.5, ceil(-1048576.5));
    printf("ceil %a = %a\n", 2097152.5,  ceil(2097152.5));
...
{
    printf("ceilf %a = %a\n", 0.0,  (double)ceilf(0.0f));
    printf("ceilf %a = %a\n", 0.5,  (double)ceilf(0.5f));
    printf("ceilf %a = %a\n", -0.5, (double)ceilf(-0.5f));
    printf("ceilf %a = %a\n", 2.0,  (double)ceilf(2.0f));
    printf("ceilf %a = %a\n", 1.5,  (double)ceilf(1.5f));
    printf("ceilf %a = %a\n", -1.5, (double)ceilf(-1.5f));
    printf("ceilf %a = %a\n", (double)1.0e7f,    (double)ceilf(1.0e7f));
    printf("ceilf %a = %a\n", (double)8388608.5f,(double)ceilf(8388608.5f));
    printf("ceilf %a = %a\n", (double)F_INF,     (double)ceilf(F_INF));
    printf("ceilf %a = %a\n", (double)F_NAN,     (double)ceilf(F_NAN));
}
...
static void test_floor_extra2(void)
{
    ...
    printf("floor %a = %a\n", 1.0e16, floor(1.0e16));
    printf("floor %a = %a\n", D_INF,  floor(D_INF));
    printf("floor %a = %a\n", 1048576.0,  floor(1048576.0));
    printf("floor %a = %a\n", 1048576.5,  floor(1048576.5));
    printf("floor %a = %a\n", -1048576.5, floor(-1048576.5));
    printf("floor %a = %a\n", 2097152.5,  floor(2097152.5));
...
static void test_floorf_extra2(void)
{
    ...
    printf("floorf %a = %a\n", (double)-0.5f,     (double)floorf(-0.5f));
    printf("floorf %a = %a\n", (double)1.5f,      (double)floorf(1.5f));
    printf("floorf %a = %a\n", (double)-1.5f,     (double)floorf(-1.5f));
    printf("floorf %a = %a\n", (double)2.0f,      (double)floorf(2.0f));
    printf("floorf %a = %a\n", (double)1.0e7f,    (double)floorf(1.0e7f));
    printf("floorf %a = %a\n", (double)8388607.5f,(double)floorf(8388607.5f));
    printf("floorf %a = %a\n", (double)F_INF,     (double)floorf(F_INF));
}
...
static void test_truncf_extra2(void)
{
    ...
    printf("truncf %a = %a\n", (double)-0.5f,  (double)truncf(-0.5f));
    printf("truncf %a = %a\n", (double)1.5f,   (double)truncf(1.5f));
    printf("truncf %a = %a\n", (double)-1.5f,  (double)truncf(-1.5f));
    printf("truncf %a = %a\n", (double)1.0e7f, (double)truncf(1.0e7f));
    printf("truncf %a = %a\n", (double)F_INF,  (double)truncf(F_INF));
    printf("truncf %a = %a\n", (double)F_NAN,  (double)truncf(F_NAN));
}
...
static void test_modf_extra2(void)
{
    ...
    printf("modf %a = %a ip=%a\n", 2.0,    modf(2.0, &ip),    ip);
    printf("modf %a = %a ip=%a\n", 1.5,    modf(1.5, &ip),    ip);
    printf("modf %a = %a ip=%a\n", 1.0e16, modf(1.0e16, &ip), ip);
    printf("modf %a = %a ip=%a\n", D_NAN,  modf(D_NAN, &ip),  ip);
    printf("modf %a = %a ip=%a\n", 1048576.0, modf(1048576.0, &ip), ip);
    printf("modf %a = %a ip=%a\n", 1048576.5, modf(1048576.5, &ip), ip);
    printf("modff %a = %a ip=%a\n", (double)0.5f,   (double)modff(0.5f,   &fip), (double)fip);
    printf("modff %a = %a ip=%a\n", (double)-0.5f,  (double)modff(-0.5f,  &fip), (double)fip);
    printf("modff %a = %a ip=%a\n", (double)2.0f,   (double)modff(2.0f,   &fip), (double)fip);
    printf("modff %a = %a ip=%a\n", (double)1.5f,   (double)modff(1.5f,   &fip), (double)fip);
    printf("modff %a = %a ip=%a\n", (double)3.0f,   (double)modff(3.0f,   &fip), (double)fip);
    printf("modff %a = %a ip=%a\n", (double)F_NAN,  (double)modff(F_NAN,  &fip), (double)fip);
    printf("modff %a = %a ip=%a\n", (double)1.0e7f, (double)modff(1.0e7f, &fip), (double)fip);
}
...
static void test_nextafter_extra2(void)
{
    ...
    printf("nextafterf 0 -1 = %a\n",  (double)nextafterf(0.0f, -1.0f));
    printf("nextafterf 2 1 = %a\n",   (double)nextafterf(2.0f, 1.0f));
    printf("nextafterf -1 0 = %a\n",  (double)nextafterf(-1.0f, 0.0f));
...
static void test_scalbn_extra2(void)
{
    ...
    printf("scalbnf 1 50001 = %a\n",  (double)scalbnf(1.0f, 50001));
    printf("scalbnf 1 -50001 = %a\n", (double)scalbnf(1.0f, -50001));
    printf("scalbnf 2 200 = %a\n",    (double)scalbnf(2.0f, 200));
    printf("scalbnf 2 -200 = %a\n",   (double)scalbnf(2.0f, -200));
}
...
static void test_scalbln_extra2(void)
{
    ...
    printf("scalblnf 1 50001 = %a\n",  (double)scalblnf(1.0f, 50001L));
    printf("scalblnf 1 -50001 = %a\n", (double)scalblnf(1.0f, -50001L));
    printf("scalblnf 2 200 = %a\n",    (double)scalblnf(2.0f, 200L));
    printf("scalblnf 2 -200 = %a\n",   (double)scalblnf(2.0f, -200L));
}
...
static void test_rint_extra2(void)
{
    ...
    printf("rint %a = %a\n", 2.0,  rint(2.0));
    /* j0 == 19: → (101:21) True */
    printf("rint %a = %a\n", 524288.1,  rint(524288.1));
    printf("rint %a = %a\n", -524288.1, rint(-524288.1));
    /* j0 > 51 */
    printf("rint %a = %a\n", 1.0e16, rint(1.0e16));
    printf("rint %a = %a\n", D_INF,  rint(D_INF));
    /* j0 in [20,51]: integral → (119:13) True */
    printf("rint %a = %a\n", 1048576.0, rint(1048576.0));
    /* j0 in [20,51]: non-integral, 2nd bit → (125:13) True */
    printf("rint %a = %a\n", 1048576.75, rint(1048576.75));
    printf("rint %a = %a\n", 1048576.5,  rint(1048576.5));
    /* rintf */
    printf("rintf %a = %a\n", (double)0.3f,       (double)rintf(0.3f));
    printf("rintf %a = %a\n", (double)1.75f,      (double)rintf(1.75f));
    printf("rintf %a = %a\n", (double)1.0e7f,     (double)rintf(1.0e7f));
    printf("rintf %a = %a\n", (double)8388608.5f, (double)rintf(8388608.5f));
}
...
static void test_round_extra2(void)
{
    ...
    printf("round %a = %a\n", 1.0e16, round(1.0e16));
    printf("round %a = %a\n", D_INF,  round(D_INF));
    printf("round %a = %a\n", 1048576.3, round(1048576.3));
    printf("round %a = %a\n", 1048576.7, round(1048576.7));
    printf("roundf %a = %a\n", (double)0.5f,  (double)roundf(0.5f));
    printf("roundf %a = %a\n", (double)-0.5f, (double)roundf(-0.5f));
    printf("roundf %a = %a\n", (double)1.5f,  (double)roundf(1.5f));
    printf("roundf %a = %a\n", (double)2.0f,  (double)roundf(2.0f));
}
...
static void test_lrint_extra2(void)
{
    ...
    printf("lrint %a = %ld\n", -0.3, lrint(-0.3));
    printf("lrint %a = %ld\n", 1.5,  lrint(1.5));
    printf("lrint %a = %ld\n", 1048576.5, lrint(1048576.5));
    /* overflow negative → (140:13) True */
    printf("lrint 1e19 = %ld\n",  lrint(1.0e19));
    printf("lrint -1e19 = %ld\n", lrint(-1.0e19));
    printf("lrintf %a = %ld\n",  (double)0.3f, (long)lrintf(0.3f));
    printf("lrintf %a = %ld\n",  (double)1.5f, (long)lrintf(1.5f));
...
static void test_lround_extra2(void)
{
    ...
    printf("lround %a = %ld\n", 1048576.7, lround(1048576.7));
    printf("lround %a = %ld\n", 1048576.3, lround(1048576.3));
    /* carry case */
    ...
    printf("lround -1e19 = %ld\n", lround(-1.0e19));
    printf("lroundf %a = %ld\n",   (double)1.5f,  (long)lroundf(1.5f));
    printf("lroundf 1e10 = %ld\n", (long)lroundf(1.0e10f));
    printf("lroundf -1e10 = %ld\n",(long)lroundf(-1.0e10f));
}
...
static void test_llrint_extra2(void)
{
    ...
    printf("llrint %a = %lld\n", -0.3, llrint(-0.3));
    printf("llrint %a = %lld\n", 1.5,  llrint(1.5));
    printf("llrint %a = %lld\n", 1048576.5, llrint(1048576.5));
    printf("llrint 1e19 = %lld\n",  llrint(1.0e19));
    printf("llrint -1e19 = %lld\n", llrint(-1.0e19));
    printf("llrintf %a = %lld\n",  (double)0.3f,  (long long)llrintf(0.3f));
    printf("llrintf %a = %lld\n",  (double)1.5f,  (long long)llrintf(1.5f));
    printf("llrintf 1e10 = %lld\n",  (long long)llrintf(1.0e10f));
    printf("llrintf -1e10 = %lld\n", (long long)llrintf(-1.0e10f));
}
...
static void test_llround_extra2(void)
{
    ...
    printf("llround %a = %lld\n",   1048576.7, llround(1048576.7));
    /* overflow negative → (118:13) True */
    printf("llround -1e19 = %lld\n", llround(-1.0e19));
    printf("llround 1e19 = %lld\n",  llround(1.0e19));
    printf("llroundf %a = %lld\n",  (double)1.5f,  (long long)llroundf(1.5f));
    printf("llroundf -1e10 = %lld\n",(long long)llroundf(-1.0e10f));
    printf("llroundf 1e10 = %lld\n", (long long)llroundf(1.0e10f));
}
...
static void test_fmax_extra2(void)
{
    ...
    printf("fmaxf snan snan = %a\n", (double)fmaxf(_snanf.f, _snan2f.f));
    printf("fmaxf qnan snan = %a\n", (double)fmaxf(_qnanf.f, _snanf.f));
    printf("fmaxf qnan 1 = %a\n",    (double)fmaxf(_qnanf.f, 1.0f));
    printf("fmaxf 1 snan = %a\n",    (double)fmaxf(1.0f, _snanf.f));
    printf("fmaxf 1 qnan = %a\n",    (double)fmaxf(1.0f, _qnanf.f));
...
static void test_fmin_extra2(void)
{
    ...
    _snan2f.u = 0x7F800002U;
    _qnanf.u  = 0x7FC00001U;
    printf("fminf snan snan = %a\n", (double)fminf(_snanf.f, _snan2f.f));
    printf("fminf qnan snan = %a\n", (double)fminf(_qnanf.f, _snanf.f));
    printf("fminf qnan 1 = %a\n",    (double)fminf(_qnanf.f, 1.0f));
    printf("fminf 1 snan = %a\n",    (double)fminf(1.0f, _snanf.f));
    printf("fminf 1 qnan = %a\n",    (double)fminf(1.0f, _qnanf.f));
...
static void test_remainder_extra2(void)
{
    ...
    printf("remainder 1e-300 1e-316 = %a\n", remainder(1.0e-300, 1.0e-316));
    printf("remainderf 5 3 = %a\n",   (double)remainderf(5.0f, 3.0f));
    printf("remainderf 5 2 = %a\n",   (double)remainderf(5.0f, 2.0f));
    printf("remainderf -5 2 = %a\n",  (double)remainderf(-5.0f, 2.0f));
    printf("remainderf 4 2 = %a\n",   (double)remainderf(4.0f, 2.0f));
    printf("remainderf 1 0 = %a\n",   (double)remainderf(1.0f, 0.0f));
}
...
static void test_remquo_extra2(void)
{
    ...
    printf("remquo -5 3 = %a q=%d\n", remquo(-5.0, 3.0, &q), q);
    printf("remquo 1e-300 1e-316 = %a q=%d\n", remquo(1.0e-300, 1.0e-316, &q), q);
    printf("remquof 5 3 = %a q=%d\n",  (double)remquof(5.0f, 3.0f, &q), q);
    printf("remquof 5 2 = %a q=%d\n",  (double)remquof(5.0f, 2.0f, &q), q);
    printf("remquof -5 3 = %a q=%d\n", (double)remquof(-5.0f, 3.0f, &q), q);
    printf("remquof 4 2 = %a q=%d\n",  (double)remquof(4.0f, 2.0f, &q), q);
}
...
static void test_hypot_extra2(void)
{
    ...
    printf("hypot 1 0 = %a\n",         hypot(1.0, 0.0));
    printf("hypot 1e155 1e155 = %a\n", hypot(1.0e155, 1.0e155));
    /* hypotf: large → scale */
    printf("hypotf 1e20 1e20 = %a\n",  (double)hypotf(1.0e20f, 1.0e20f));
    printf("hypotf 1e-30 1e-30 = %a\n",(double)hypotf(1.0e-30f, 1.0e-30f));
}
...
static void test_csqrt_extra2(void)
{
    ...
    zf = CMPLXF(0.0f, -4.0f);
    wf = csqrtf(zf);
    printf("csqrtf 0-4i = %a+%ai\n", (double)crealf(wf), (double)cimagf(wf));
...
static void test_expm1_extra2(void)
{
    ...
    printf("expm1 0.3 = %a\n",    expm1(0.3));
    printf("expm1 -0.3 = %a\n",   expm1(-0.3));
    printf("expm1f 100 = %a\n",   (double)expm1f(100.0f));
    printf("expm1f -100 = %a\n",  (double)expm1f(-100.0f));
    printf("expm1f 0.5 = %a\n",   (double)expm1f(0.5f));
    printf("expm1f 1e-10 = %a\n", (double)expm1f(1.0e-10f));
    printf("expm1f 0.3 = %a\n",   (double)expm1f(0.3f));
}
...
static void test_fmod_s5(void)
{
    ...
    printf("fmodf(1,3) = %a\n", fmodf(1.0f, 3.0f));
    printf("fmodf(3,3) = %a\n", fmodf(3.0f, 3.0f));
    printf("fmodf(sn,3) = %a\n", fmodf(F_SUBNORM, 3.0f));
    printf("fmodf(1,sn) = %a\n", fmodf(1.0f, F_SUBNORM));
...
static void test_ctan_s5(void)
{
    ...
    printf("ctanf(pi/2+0.1i) = %a+%ai\n", crealf(ctanf(zf)), cimagf(ctanf(zf)));

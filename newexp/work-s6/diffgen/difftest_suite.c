...
int main(void)
{
    ...
    /* Coverage-targeted: double special values */
    run_test("acos_cov", test_acos_cov, 2);
    run_test("asin_cov", test_asin_cov, 2);
    run_test("atan2_cov", test_atan2_cov, 2);
    run_test("acosh_cov", test_acosh_cov, 2);
    run_test("asinh_cov", test_asinh_cov, 2);
    run_test("atanh_cov", test_atanh_cov, 2);
    run_test("cosh_cov", test_cosh_cov, 2);
    run_test("sinh_cov", test_sinh_cov, 2);
    run_test("tanh_cov", test_tanh_cov, 2);
    run_test("exp_cov", test_exp_cov, 2);
    run_test("expm1_cov", test_expm1_cov, 2);
    run_test("frexp_cov", test_frexp_cov, 2);
    run_test("ilogb_cov", test_ilogb_cov, 2);
    run_test("ldexp_cov", test_ldexp_cov, 2);
    run_test("log_cov", test_log_cov, 2);
    run_test("log10_cov", test_log10_cov, 2);
    run_test("log2_cov", test_log2_cov, 2);
    run_test("log1p_cov", test_log1p_cov, 2);
    run_test("logb_cov", test_logb_cov, 2);
    run_test("cbrt_cov", test_cbrt_cov, 2);
    run_test("hypot_cov", test_hypot_cov, 2);
    run_test("pow_cov", test_pow_cov, 2);
    run_test("sqrt_cov", test_sqrt_cov, 2);
    run_test("ceil_cov", test_ceil_cov, 2);
    run_test("floor_cov", test_floor_cov, 2);
    run_test("trunc_cov", test_trunc_cov, 2);
    run_test("round_cov", test_round_cov, 2);
    run_test("rint_cov", test_rint_cov, 2);
    run_test("lrint_cov", test_lrint_cov, 2);
    run_test("llrint_cov", test_llrint_cov, 2);
    run_test("lround_cov", test_lround_cov, 2);
    run_test("llround_cov", test_llround_cov, 2);
    run_test("modf_cov", test_modf_cov, 2);
    run_test("fmod_cov", test_fmod_cov, 2);
    run_test("remainder_cov", test_remainder_cov, 2);
    run_test("remquo_cov", test_remquo_cov, 2);
    run_test("nextafter_cov", test_nextafter_cov, 2);
    run_test("scalbn_cov", test_scalbn_cov, 2);
    run_test("scalbln_cov", test_scalbln_cov, 2);
    run_test("fmax_cov", test_fmax_cov, 2);
    run_test("fmin_cov", test_fmin_cov, 2);
    run_test("fdim_cov", test_fdim_cov, 2);
    run_test("fabs_cov", test_fabs_cov, 2);
    run_test("copysign_cov", test_copysign_cov, 2);
    run_test("erf_cov", test_erf_cov, 2);
    run_test("erfc_cov", test_erfc_cov, 2);
    run_test("lgamma_cov", test_lgamma_cov, 2);
    run_test("tgamma_cov", test_tgamma_cov, 2);
    run_test("j0_cov", test_j0_cov, 2);
    run_test("j1_cov", test_j1_cov, 2);
    run_test("jn_cov", test_jn_cov, 2);
    run_test("y0_cov", test_y0_cov, 2);
    run_test("y1_cov", test_y1_cov, 2);
    run_test("yn_cov", test_yn_cov, 2);
    run_test("fpclassify_cov", test_fpclassify_cov, 2);
    run_test("sin_cov", test_sin_cov, 2);
    run_test("cos_cov", test_cos_cov, 2);
    run_test("tan_cov", test_tan_cov, 2);

    /* Coverage-targeted: float special values */
    run_test("acosf_cov", test_acosf_cov, 2);
    run_test("asinf_cov", test_asinf_cov, 2);
    run_test("atanf_cov", test_atanf_cov, 2);
    run_test("atan2f_cov", test_atan2f_cov, 2);
    run_test("acoshf_cov", test_acoshf_cov, 2);
    run_test("asinhf_cov", test_asinhf_cov, 2);
    run_test("atanhf_cov", test_atanhf_cov, 2);
    run_test("coshf_cov", test_coshf_cov, 2);
    run_test("sinhf_cov", test_sinhf_cov, 2);
    run_test("tanhf_cov", test_tanhf_cov, 2);
    run_test("expf_cov", test_expf_cov, 2);
    run_test("expm1f_cov", test_expm1f_cov, 2);
    run_test("frexpf_cov", test_frexpf_cov, 2);
    run_test("ilogbf_cov", test_ilogbf_cov, 2);
    run_test("logf_cov", test_logf_cov, 2);
    run_test("log10f_cov", test_log10f_cov, 2);
    run_test("log2f_cov", test_log2f_cov, 2);
    run_test("log1pf_cov", test_log1pf_cov, 2);
    run_test("logbf_cov", test_logbf_cov, 2);
    run_test("cbrtf_cov", test_cbrtf_cov, 2);
    run_test("hypotf_cov", test_hypotf_cov, 2);
    run_test("powf_cov", test_powf_cov, 2);
    run_test("sqrtf_cov", test_sqrtf_cov, 2);
    run_test("erff_cov", test_erff_cov, 2);
    run_test("erfcf_cov", test_erfcf_cov, 2);
    run_test("lgammaf_cov", test_lgammaf_cov, 2);
    run_test("tgammaf_cov", test_tgammaf_cov, 2);
    run_test("ceilf_cov", test_ceilf_cov, 2);
    run_test("floorf_cov", test_floorf_cov, 2);
    run_test("truncf_cov", test_truncf_cov, 2);
    run_test("roundf_cov", test_roundf_cov, 2);
    run_test("rintf_cov", test_rintf_cov, 2);
    run_test("lrintf_cov", test_lrintf_cov, 2);
    run_test("llrintf_cov", test_llrintf_cov, 2);
    run_test("lroundf_cov", test_lroundf_cov, 2);
    run_test("llroundf_cov", test_llroundf_cov, 2);
    run_test("modff_cov", test_modff_cov, 2);
    run_test("fmodf_cov", test_fmodf_cov, 2);
    run_test("remainderf_cov", test_remainderf_cov, 2);
    run_test("nextafterf_cov", test_nextafterf_cov, 2);
    run_test("scalbnf_cov", test_scalbnf_cov, 2);
    run_test("scalblnf_cov", test_scalblnf_cov, 2);
    run_test("fmaxf_cov", test_fmaxf_cov, 2);
    run_test("fminf_cov", test_fminf_cov, 2);
    run_test("fabsf_cov", test_fabsf_cov, 2);
    run_test("copysignf_cov", test_copysignf_cov, 2);
    run_test("sinf_cov", test_sinf_cov, 2);
    run_test("cosf_cov", test_cosf_cov, 2);
    run_test("tanf_cov", test_tanf_cov, 2);

    /* Coverage-targeted: complex edge cases */
    run_test("csqrt_cov", test_csqrt_cov, 2);
    run_test("csqrtf_cov", test_csqrtf_cov, 2);
    run_test("catan_cov", test_catan_cov, 2);
    run_test("catanf_cov", test_catanf_cov, 2);
    run_test("cpow_cov", test_cpow_cov, 2);
    run_test("cpowf_cov", test_cpowf_cov, 2);
    run_test("cproj_cov", test_cproj_cov, 2);
    run_test("cprojf_cov", test_cprojf_cov, 2);
    run_test("ctan_cov", test_ctan_cov, 2);
    run_test("ctanf_cov", test_ctanf_cov, 2);

    /* Coverage round 3: additional branches */
    run_test("trig_moderate", test_trig_moderate, 2);
    run_test("asin_moderate", test_asin_moderate, 2);
    run_test("atan_extra", test_atan_extra, 2);
    run_test("acosf_acoshf_extra", test_acosf_acoshf_extra, 2);
    run_test("cpow_imagexp", test_cpow_imagexp, 2);
    run_test("cpowf_imagexp", test_cpowf_imagexp, 2);
    run_test("csqrt_large_imag", test_csqrt_large_imag, 2);
    run_test("csqrtf_large_imag", test_csqrtf_large_imag, 2);
    run_test("ctan_extra", test_ctan_extra, 2);
    run_test("ctanf_extra", test_ctanf_extra, 2);
    run_test("ccoshsinh_extreme", test_ccoshsinh_extreme, 2);
    run_test("snan", test_snan, 2);
    run_test("ldexpf_extra", test_ldexpf_extra, 2);
    run_test("asinhf_extra", test_asinhf_extra, 2);
    run_test("remquof_extra", test_remquof_extra, 2);
    run_test("atanf_extra", test_atanf_extra, 2);
    run_test("catanf_extra", test_catanf_extra, 2);

    /* Coverage round 4: additional uncovered branches */
    run_test("lgamma_coverage2", test_lgamma_coverage2, 2);
    run_test("lgammaf_coverage2", test_lgammaf_coverage2, 2);
    run_test("sinh_cosh_overflow", test_sinh_cosh_overflow, 2);
    run_test("jn_coverage2", test_jn_coverage2, 2);
    run_test("yn_coverage2", test_yn_coverage2, 2);
    run_test("atan_xlarge", test_atan_xlarge, 2);
    run_test("y0_y1_extreme", test_y0_y1_extreme, 2);
    run_test("bessel_ranges", test_bessel_ranges, 2);
    run_test("pow_coverage2", test_pow_coverage2, 2);
    run_test("trig_coverage2", test_trig_coverage2, 2);
    run_test("erff_coverage2", test_erff_coverage2, 2);
    run_test("erfcf_coverage2", test_erfcf_coverage2, 2);
    run_test("atanhf_coverage2", test_atanhf_coverage2, 2);
    run_test("rint_coverage2", test_rint_coverage2, 2);
    run_test("coshf_sinhf_extra", test_coshf_sinhf_extra, 2);
    run_test("log_coverage2", test_log_coverage2, 2);

    /* Coverage round 5: additional uncovered branches */
    run_test("scalbn_coverage3", test_scalbn_coverage3, 2);
    run_test("scalbnf_coverage3", test_scalbnf_coverage3, 2);
    run_test("modf_coverage2", test_modf_coverage2, 2);
    run_test("modff_coverage2", test_modff_coverage2, 2);
    run_test("nextafter_coverage2", test_nextafter_coverage2, 2);
    run_test("nextafterf_coverage2", test_nextafterf_coverage2, 2);
    run_test("lround_coverage2", test_lround_coverage2, 2);
    run_test("llround_coverage2", test_llround_coverage2, 2);
    run_test("lroundf_coverage2", test_lroundf_coverage2, 2);
    run_test("llroundf_coverage2", test_llroundf_coverage2, 2);
    run_test("lrint_coverage2", test_lrint_coverage2, 2);
    run_test("llrint_coverage2", test_llrint_coverage2, 2);
    run_test("lrintf_coverage2", test_lrintf_coverage2, 2);
    run_test("llrintf_coverage2", test_llrintf_coverage2, 2);
    run_test("remquof_coverage2", test_remquof_coverage2, 2);
    run_test("fmod_coverage2", test_fmod_coverage2, 2);
    run_test("fmodf_coverage2", test_fmodf_coverage2, 2);
    run_test("remainder_coverage2", test_remainder_coverage2, 2);
    run_test("remquo_coverage2", test_remquo_coverage2, 2);
    run_test("remainderf_coverage2", test_remainderf_coverage2, 2);
    run_test("hypot_snan", test_hypot_snan, 2);
    run_test("ceil_floor_extra", test_ceil_floor_extra, 2);
    run_test("ceilf_floorf_extra", test_ceilf_floorf_extra, 2);
    run_test("log_coverage3", test_log_coverage3, 2);
    run_test("trig_coverage3", test_trig_coverage3, 2);
    run_test("gamma_coverage2", test_gamma_coverage2, 2);
    run_test("ilogb_coverage2", test_ilogb_coverage2, 2);
    run_test("bessel_coverage2", test_bessel_coverage2, 2);
    run_test("logb_coverage2", test_logb_coverage2, 2);
    run_test("acoshd_atanhd_extra", test_acoshd_atanhd_extra, 2);
    run_test("float_coverage3", test_float_coverage3, 2);

    /* Coverage round 6: targeted remaining uncovered branches */
    run_test("ceil_round6", test_ceil_round6, 2);
    run_test("floor_round6", test_floor_round6, 2);
    run_test("trunc_round6", test_trunc_round6, 2);
    run_test("rint_round6", test_rint_round6, 2);
    run_test("exp_round6", test_exp_round6, 2);
    run_test("sinh_cosh_round6", test_sinh_cosh_round6, 2);
    run_test("lgamma_round6", test_lgamma_round6, 2);
    run_test("bessel_round6", test_bessel_round6, 2);
    run_test("scalbn_round6", test_scalbn_round6, 2);
    run_test("atan2_round6", test_atan2_round6, 2);
    run_test("float_round6", test_float_round6, 2);

    /* Coverage round 7: targeted remaining uncovered branches */
    run_test("erf_round7", test_erf_round7, 2);
    run_test("erfc_round7", test_erfc_round7, 2);
    run_test("expm1_round7", test_expm1_round7, 2);
    run_test("expm1f_round7", test_expm1f_round7, 2);
    run_test("logf_round7", test_logf_round7, 2);
    run_test("log1p_round7", test_log1p_round7, 2);
    run_test("pow_round7", test_pow_round7, 2);

    /* Coverage round 8: additional uncovered branches */
    run_test("fmax_fmin_round8", test_fmax_fmin_round8, 2);
    run_test("log_round8", test_log_round8, 2);
    run_test("log1p_round8", test_log1p_round8, 2);
    run_test("sqrt_round8", test_sqrt_round8, 2);
    run_test("ceil_floor_trunc_round8", test_ceil_floor_trunc_round8, 2);
    run_test("complex_round8", test_complex_round8, 2);
    run_test("fpclassify_round8", test_fpclassify_round8, 2);
    run_test("bessel_round8", test_bessel_round8, 2);
    run_test("llrint_round8", test_llrint_round8, 2);
    run_test("remainder_round8", test_remainder_round8, 2);
    run_test("atan2f_round8", test_atan2f_round8, 2);
    run_test("tanhf_round8", test_tanhf_round8, 2);
    run_test("gammaf_round8", test_gammaf_round8, 2);
    run_test("powf_round8", test_powf_round8, 2);
    run_test("fmodf_round8", test_fmodf_round8, 2);
    run_test("remquof_round8", test_remquof_round8, 2);

    /* Coverage round 9: targeted remaining uncovered branches */
    run_test("atan2_round9", test_atan2_round9, 2);
    run_test("atan2f_round9", test_atan2f_round9, 2);
    run_test("acosh_asinh_round9", test_acosh_asinh_round9, 2);
    run_test("atand_round9", test_atand_round9, 2);
    run_test("trunc_round9", test_trunc_round9, 2);
    run_test("rint_round9", test_rint_round9, 2);
    run_test("sqrt_round9", test_sqrt_round9, 2);
    run_test("frexp_modf_round9", test_frexp_modf_round9, 2);
    run_test("bessel_round9", test_bessel_round9, 2);
    run_test("logd_round9", test_logd_round9, 2);
    run_test("nextafter_round9", test_nextafter_round9, 2);
    run_test("pow_round9", test_pow_round9, 2);
    run_test("remainder_remquo_round9", test_remainder_remquo_round9, 2);
    run_test("trig_extreme_round9", test_trig_extreme_round9, 2);
    run_test("log1pf_round9", test_log1pf_round9, 2);
    run_test("truncf_round9", test_truncf_round9, 2);
    run_test("powf_round9", test_powf_round9, 2);

    /* Coverage round 10: targeted remaining uncovered branches */
    run_test("ceil_r10", test_ceil_r10, 2);
    run_test("floor_r10", test_floor_r10, 2);
    run_test("trunc_r10", test_trunc_r10, 2);
    run_test("fmax_fmin_snan_r10", test_fmax_fmin_snan_r10, 2);
    run_test("fmaxf_fminf_snan_r10", test_fmaxf_fminf_snan_r10, 2);
    run_test("rem_pio2_r10", test_rem_pio2_r10, 2);
    run_test("rem_pio2f_r10", test_rem_pio2f_r10, 2);
    run_test("bessel_r10", test_bessel_r10, 2);
    run_test("log_r10", test_log_r10, 2);
    run_test("llrint_llround_r10", test_llrint_llround_r10, 2);
    run_test("ceilf_r10", test_ceilf_r10, 2);
    run_test("floorf_r10", test_floorf_r10, 2);
    run_test("truncf_r10", test_truncf_r10, 2);
    run_test("atan2f_r10", test_atan2f_r10, 2);
    run_test("powf_r10", test_powf_r10, 2);
    run_test("remainderf_r10", test_remainderf_r10, 2);
    run_test("remquof_r10", test_remquof_r10, 2);
    run_test("ctan_r10", test_ctan_r10, 2);
    run_test("gamma_r10", test_gamma_r10, 2);
    run_test("pow_r10", test_pow_r10, 2);
    run_test("fmod_r10", test_fmod_r10, 2);
    run_test("hypotd_r10", test_hypotd_r10, 2);
    run_test("scalblnf_r10", test_scalblnf_r10, 2);
    run_test("modff_r10", test_modff_r10, 2);
    run_test("frexp_r10", test_frexp_r10, 2);
    run_test("nextafter_r10", test_nextafter_r10, 2);
    run_test("asinf_r10", test_asinf_r10, 2);
    run_test("erfcf_r10", test_erfcf_r10, 2);
    run_test("log10f_r10", test_log10f_r10, 2);
    run_test("log1pf_r10", test_log1pf_r10, 2);
    run_test("remquod_r10", test_remquod_r10, 2);
    run_test("sqrtd_r10", test_sqrtd_r10, 2);
    run_test("cprojd_r10", test_cprojd_r10, 2);

    /* Coverage round 11: targeted remaining uncovered branches */
    run_test("trunc_r11", test_trunc_r11, 2);
    run_test("ceil_carry_r11", test_ceil_carry_r11, 2);
    run_test("fmod_r11", test_fmod_r11, 2);
    run_test("fmodf_r11", test_fmodf_r11, 2);
    run_test("pow_r11", test_pow_r11, 2);
    run_test("atan2d_r11", test_atan2d_r11, 2);
